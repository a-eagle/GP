...
var TOKEN_SERVER_TIME = new Date().getTime() / 1000; // 1684212000.849;
!function (n, t) {
    !function () {
        var r,
        e,
        ...
        Qn;
        !function (n) { // init Qn Object, it is an {allow: true, Init: function, getCookie: function, setCookie: function, delCookie: function}
            n[e[53]] = s[67];
            function t(n) {
                var t = r[51][u[68]],
                o = u[69] + n + s[70],
                i = t.indexOf(o);
                if (i == -e[54]) {
                    if (o = n + c[70], t.substr(r[52], o.length) != o)
                        return;
                    i = a[52]
                }
            ...
            n[s[76]] = t; // n['getCookie'] = t;
            function i(n, t, r) {
                this.setCookie(n, u[1], u[77], t, r)
            }
            n[s[78]] = o; // n['setCookie' ] = o;
            function f() {
                var t = a[60];
            ...
            n[Wn(N, r[62], c[79])] = i // n['delCookie'] = i
        }
        (Qn || (Qn = {}));

        var Zn;
        !function (n) { // init Zn Object, {Init: , set: , get: , del: }
            var t = u[80],
            o = v(nn, s[81], u[82]),
            i = s[67],
            f,
        ...
        // qn = function() , with toBuffer(), decodeBuffer() method
        var qn = function () {
            var n,
            t,
            r;
            ...
            c = o[102],
            f = e[103];
            function l(r) { // r = Array(18)    constructor
                var a = o[102],
                i = e[103];
                this[n[76]] = r; // this['base_fileds'] = r;
                for (var u = t[52], c = r[a + g + i]; u < c; u++) {
                    this[u] = t[52]; // set l[0-18] = 0
                }
            }
            l[e[104]][w + m + I + u] = function () { // l.prototype.toBuffer = function()
            ...
            l[v(t[80], t[81], b)][ot(i[107])] = function (n) {// l.prototype.decodeBuffer = function() 
        ...
        zn;
        !function (n) { // init zn Object = {base64Encode: , base64Decode:,  encode: , decode: }
            var t = s[13],
            o = c[53],
            i = r[83],
            f = r[84],
            ...
            for (var m = at(u[115], s[116]), I = {}, y = u[2]; y < parseInt(i + A, e[93]); y++) {
                I[m.charAt(y)] = y; // I = {A: 0, B: 1, C: 2, ...., a: , b : ..., 0: , 1: , ..., -: , _: }
            }
            ...
            n[e[97]] = w, // n['base64Encode'] = function()
            n[R + k + S] = O, // n['base64Decode'] = function()
            n[u[125]] = N, // n['encode'] = function()
            n[d + P + M] = D // n['decode'] = function()
        } (zn || (zn = {}));

        var Jn;
        !function (n) { // init Jn = { analysisRst: ,  booleanToDecimal: , getHostFromUrl: , getOriginFromUrl: , getRootDomain: , getServerTime: ,isIPAddr: ,parse: ,random: ,serverTimeNow : , strToBytes: , strhash: , timeNow: }
            var t = Fn,
            o = at(c[126], a[98]),
            i = r[99],
            f = v(U, u[127]),
            ...
            function T(n) {
                ...
                i = function (n, o) {
                    ...
                    p,
                    d;
                    for (o = o.replace(s[132], u[1]), o = o.substring(u[0], o[e[56]] - c[0]), f = o.split(c[133]), p = c[2]; p < f[i + t + O]; p++)
            ...
            function P(n) {
                ...
                if (!(n > e[122])) {
                    ...
                    _ = a[51].createElement(u[144]); // <script> Element
                    t = Q,

                    // _.src = 'https://s.thsi.cn/js/chameleon/time.11414806.js'
                    // _.src = location['procotal'] + '1' + parseInt(new Date().getTime() / 1200000) + '.js'
                    _[c[145]] = location[r[123]] + a[124] + parseInt((new r[105]).getTime() / y) + (f + o + l), 
                    // _.src = _.src.replace('file', 'https')
                    _[e[125]] = function () { // _.onerror = function() 
                        Vn = u[0],
                        setTimeout(function () {
                            P(++n)
                        }, n * parseInt(e[126], u[84]))
                    },
                    _[p + L + d] = _[s[146]] = function () { // _.onload = _.onreadystatechange = function() 
                        var n,
                        t,
                        r;
                        n = t = r = a;
                    ...
                    c[66][m + I].appendChild(_) // document.body.appendChild(_)
                }
            }
            function M(n) {
                var t,
            ...
            n[Y + C + j] = T,  // n.parse = function()
            t = En,
            n[c[156]] = P,     // n.getServerTime = function()
            n[ot(u[157])] = B, // n.analysisRst = function()
            n[r[132]] = A,     // n.strToBytes = function()
            n[c[158]] = G,     // n.strhash = function()
            n[c[159]] = k,     // n.random = function()
            n[r[133]] = M,     // n.isIPAddr = 
            n[s[160]] = Z,     // n.getRootDomain  = 
            n[E + H] = S,      // n.getHostFromUrl = 
            n[$ + U] = K,      // n.getOriginFromUrl = 
            n[s[161]] = z,     // n.booleanToDecimal = 
            n[s[162]] = b,     // n.timeNow = 
            n[r[134]] = X;     // n.serverTimeNow = 
            var q = !!a[65][a[135]]; // q = !! window.addEventListener
            function z(n) {
            ...
            n[u[164]] = R;   // n.eventBind = 
        }(Jn || (Jn = {}));

        var nt;
        !function (n) {  // init nt = {getMouseMove: , getMouseWheel, getMouseClick, getKeyDown, getClickPos}
            var t = u[165],
            o = a[137],
            i = at(s[166], s[167]),
            v = u[168],
            ...
            I = s[2],
            y = s[67],
            _ = t + X in s[66].createElement(s[171]) ? o + G + i : s[172]in c[66] ? u[173] : v + K + f + Q; // _ = 'wheel'
            Jn.eventBind(s[66], _, S),          // document.addEventListner('wheel', S)
            Jn.eventBind(a[51], r[139], T),     // document.addEventListner(mousemove, T)
            Jn.eventBind(u[66], Wn(e[140], e[141], s[174]), T), // document.addEventListner(touchmove, T)
            Jn.eventBind(c[66], l + Z + q, M),   // document.addEventListner(click, M)
            Jn.eventBind(u[66], c[175], b);      // document.addEventListner(keydown, b)
            function C() {
                return w
            }
            function E() {
            ...
            function M(n) { // n = PointerEvent
                ...
                var s = (S, A, u[36]);
                g++,
                y = void 0 == n[s + z] || n[J + nn], // y = n.isTrusted (true),  must true ?
                m = n[ot(r[142], o[84])], // n.clicntX
                I = n[i[176]] // n.clientY
            }
            n[e[143]] = E,       // n.getMouseMove = E
            n[ot(e[144])] = R,   // n.getMouseWheel = R
            n[e[145]] = k,       // n.getMouseClick = k
            n[u[177]] = C,       // n.getKeyDown = C
            n[tn + p + rn] = P   // n.getClickPos = P
        } (nt || (nt = {}));

        var tt; // 一个跟浏览器相关的对象
        !function (n) { // init tt = {getPlatform: , getBrowserIndex: , getPluginNum: , getBrowserFeature: }
            var t = e[146],
            f = c[4],
            l = c[178],
            p = u[179],
            ...
            var O = navigator[s[201]]; // O = navigator.plugins  is Array
            function D() {
                var n,
                t,
                r;
            ...
            n[s[213]] = V,  // n.getPlatform = 
            n[c[214]] = M,  // n.getBrowserIndex = 
            n[e[191]] = P,  // n.getPluginNum = 
            n[e[192]] = W   // n.getBrowserFeature = 
        } (tt || (tt = {}));

        var rt; // 生成henxin-v的参数
        !function (n) { // init rt = {Init: , update: }
            var t = e[87],
            o = a[8],
            i = e[8],
            f = s[215],
            ...
            n[v(an, a[198], r[199])] = D; // n.update = D
            
            window._rt_ = n;
        } (rt || (rt = {}));

        var et;
        function at() { // 在两个加密数组中取数据（带参数）
            var n,
            t,
            r;
            n = t = r = u;
            ...
            i;
            a = o = i = e;
            var c = arguments[o[52]]; // arguments[0]
            if (!c)
                return t[1];
        ...
        !function (n) {
            ...
            B,
            R;
            function k(n) { // n is a url
                var r = o[227], // r = 'al'
                e = t[204]; // e = 'lo'
                return j(n) && Qn[r + e + s]; // Qn[r + e + s] = Qn['alloc']
            }
            function S(n, t, e) {
                var a,
                i,
            ...
            function M() {
                ...
                Jn.eventBind(t[51], r[209], function (n) {
                    var t = i[236];
                    n = n || event;
                    var r = n[bn + t + p] || n[Wn(o[5], c[237], o[238])]; // n.target  (Event.target)
                    do {
                        if (r[i[240]] == i[241]) {
                            a(r) && D();
                            break
                        }
                    } while (r = r[i[239]])  // r = r.parentNode
                }),
            ...
            function N() {
                ...
                H(t[216], function (n) {
                    return function (t, a) {
                        ...
                        var l = D();
                        return a = a || {},
                        Qn[at(u[219], K)] ? X(t) ? k || (t = L(t)) : a[i[220]] ? a[v[252]][jn] = l : (a[s[252]] = new Headers, a[u[220]].append(jn, l)) : (l = rt.update(), a[f[252]] ? a[Bn + d][jn] = l : (a[h + r] = new Headers, a[i[220]].append(jn, l))),
                        n.call(this, t, a)
                    }
                })
            }
            function L(n) { // n is a url
                for (var a = rt.update(), u = Gn, s = c[2]; s < u[Rn + kn]; s++) // u = [/s.thsi.cn/, /so.thsi.cn/] ;  s = 0, 1,..  ;  s < u.length
                    if (u[s].test(n))
                        return n;
					let mmm1 = v(r[82], r[221], t[222]); let mmf = t[47]; // mmm1='\?' mmf = RegExp
					let mmo = o[255]; // mmo = encodeURIComponent
                return n + (new mmf(mmm1).test(n) ? Wn(c[253], i[254], bn) : e[223]) + Yn + c[70] + o[255](a); // n + (new RegExp('\?').test(url)) ? Wn() : '?') + 'henxin-v' + '=' + encodeURIComponent(a)
            }
            function W(n) {
                var t = cn,
                a = i[16],
            ...
            function Y() {
                var n = i[83][Wn(x, c[259])]; // n = XMLHttpRequest
                n && W(n.prototype),
                r[65][o[188]] && P()
            }
            function j(n) { // n is a url
                var r = rn; // r = 'Pos'
                r = p; // r = 'et'
            ...
            function $() {
                var n = at(c[261]),  // n = appendChild, HTML Element's appendChild
                e = c[262], // RI
                a = r[226];// s
                function u(n) {
                    return function (t) { // t =  HTML Element <script>
                        try {
                            s(t); // call line: 1293
                        } catch (r) {
                            return r
                ...
                function s(r) { // t =  HTML Element <script>
                    var u = it, // u = {}
                    c = i[50],  // c = 'ta'
                    s = at(o[263], i[264]); // call line: 1039  s=gN
                    if (r && r[c + s + Mn + On] == n + e + Dn) {  // r['tagName'] 'SCRIPT' == 'SCRIPT'
                        var v = r[t[227]]; // v = t.src
                        u = F, // u = 'ySta'
            ...
            function V(n) { // n is a url ，测试url是否是thsi.cn 或 baidu
                var t = Xn, // t = [/thsi.cn/, /.baidu./]
                e = o[83][r[232]];
                e && (t = t.concat(e));
                for (var a = i[2]; a < t[c[111]]; a++) // var a = 0; a < 2; a++
                    if (t[a].test(n))
                        return o[67];
                return o[86]; // true | false
            }
            function X(n) {
        ...
        !function (n) {  // 启动始化（入口函数）
            ...
            function i() {
                var n = parseInt(t + Nn, s[113]); //  1200秒 (20分钟)
                setInterval(function () {
                    Jn.getServerTime() // 服务器时间， 单位: 秒
                }, n) 
            }
            function c() {
                Qn.Init(),
            ...
            u[83][v(r[236], e[237])] || (o(), u[83][a[238]] = a[44]) // window['CHAMELEON_LOADED'] || (o(), window['CHAMELEON_LOADED'] = true)
        } (it || (it = {}))
...
// call window._rt_.update() to get henxin-v param